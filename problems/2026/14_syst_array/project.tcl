...
add_files -fileset sources_1 -norecurse {
  ./sa/syst_array/sa_top.sv
  ./sa/syst_array/sa_core.sv
  ./sa/syst_array/pe.sv
  ./sa/syst_array/sr.sv
  ./sa/syst_array/we_line.sv
  ./sa/syst_array/delay_line.sv
  ./sa/syst_array/delay_line_rev.sv
  ./sa/credit/credit.sv
  ./sa/credit/fifo.sv
  ./sa/axi/addr_gen.sv
  ./sa/axi/sa_ctrl.sv
...
create_bd_cell -type module -reference sa_axi_top sa_axi_top_0 
...
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins sa_axi_top_0/clk]
...
connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins sa_axi_top_0/rst_n]

connect_bd_intf_net [get_bd_intf_pins sa_axi_top_0/m_axi] [get_bd_intf_pins smartconnect_0/S00_AXI]
...
connect_bd_intf_net [get_bd_intf_pins axi_protocol_convert_0/M_AXI] [get_bd_intf_pins sa_axi_top_0/s_axil]

connect_bd_net  [get_bd_pins sa_axi_top_0/o_irq] [get_bd_pins processing_system7_0/IRQ_F2P]
